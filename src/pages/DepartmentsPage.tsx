...
import { departments, users, getProjectsByDepartment, getUsersByDepartment, getUser, getRoleName, getInitials } from '@/data/mockData';
          ...
          return (
            <div key={dept.id} className="surface-card-hover p-5 space-y-4">
              <div className="flex items-start justify-between">
                <div>
                  ...
                  <p className="text-xs text-muted-foreground">
                    {projs.length} projects · {activeProjs.length} active
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-center gap-1">
                ...
                {members.length > 5 && (
                  <span className="text-[11px] text-muted-foreground ml-1">+{members.length - 5}</span>
                )}
