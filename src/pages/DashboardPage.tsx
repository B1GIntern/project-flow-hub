...
import { departments, users, projects, tasks, kpis, getRoleName, getUser, getDepartment, getProjectsByDepartment, getTasksByUser } from '@/data/mockData';
import { CheckSquare, FolderKanban, Users, Building2, TrendingUp, Clock } from 'lucide-react';
        ...
        <div className="surface-card">
          <div className="px-4 py-3 border-b border-border">
            <h2 className="text-sm font-semibold">
              {currentRole === 'EMPLOYEE' ? 'My Tasks' : 'Recent Tasks'}
            </h2>
          </div>
                ...
                <div key={task.id} className="data-table-row">
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <p className="text-xs text-muted-foreground">
                      {getDepartment(project?.departmentId ?? 0)?.name} · {project?.name}
                    </p>
                  </div>
                        ...
                        {latestKpi ? (
                          <>
                            ...
                            <span className="font-mono text-xs tabular-nums text-muted-foreground">
                              {latestKpi.tasksCompleted} tasks
                            </span>
                          </>
                        ) : (
