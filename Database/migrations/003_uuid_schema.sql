-- ==============================================
-- Migrate to UUID primary keys (non-guessable IDs)
-- Run this after dropping existing data or on a fresh DB
-- ==============================================

-- Drop existing tables (CASCADE handles FKs)
